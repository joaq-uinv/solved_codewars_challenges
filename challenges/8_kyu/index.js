...
String.prototype.toJadenCase = function () {
  return this.split(" ") //make an array which elements are the words in the string
    .map((str) => str.charAt(0).toUpperCase() + str.slice(1)) //for each word capitalize its first character and create a string without its first character and create an array out of this
    .join(" "); //join the elements in the array to return a string
};
